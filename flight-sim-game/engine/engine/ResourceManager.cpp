...
void ResourceManager::drawScene(glm::mat4 viewMatrix, glm::mat4 perspectiveMatrix, glm::mat4 uiProjection, glm::vec3 lightPos, glm::vec3 lightPos2)
{
	...
	glUniform3f(complexShader->u("lightPos2"), lightPos2.x, lightPos2.y, lightPos2.z);
	...
	glUniform3f(simpleShader->u("lightPos2"), lightPos2.x, lightPos2.y, lightPos2.z);
	...
	for (GameObject* object : renderQueue)
	{
		...
		glUniform1f(complexShader->u("isReflective"), object->isReflective);
